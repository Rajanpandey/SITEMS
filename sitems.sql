...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2018 at 08:07 PM
...
CREATE TABLE `events` (
  ...
  `incharge` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `date` date NOT NULL,
  `type` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `eventDescribe` varchar(5000) COLLATE utf8_unicode_ci NOT NULL,
  `achievements` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `attendees` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `eventFor` varchar(5000) COLLATE utf8_unicode_ci NOT NULL,
  `category` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  `media` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `userId` int(11) NOT NULL,
  `url` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `approvalStatus` tinyint(4) DEFAULT NULL,
  `declineReply` varchar(5000) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `events` (`eventId`, `name`, `department`, `incharge`, `date`, `type`, `eventDescribe`, `achievements`, `attendees`, `eventFor`, `category`, `media`, `userId`, `url`, `approvalStatus`, `declineReply`, `viewedNotification`) VALUES
...
(35, 'Hackathon', 'EnTc', 'HackathonHackathon', '2018-09-05', 'Co-Curricular Activity', 'Hackathon', 'Hackathon', 'Faculty', 'B.Tech,M.Tech', 'Annual College Gathering Fest', '2018/EnTc/September - AnnualCollegeGatheringFest/Hackathon/Screenshot (69).png', 1, 'hackathon', -1, 'asd', NULL),
...
(38, 'New Event', 'CSIT', 'New Event', '2018-09-05', 'Co-Curricular Activity', 'New Event', 'New EventNew Event', 'Staff', 'B.Tech', 'Conference', '2018/CSIT/September - Conference/New Event/Screenshot (69).png', 1, 'new-event', -1, 'hii', 1),
(39, '1', 'EnTc', '1', '2018-09-08', 'Curricular Activity', '1', '1', 'Staff', 'B.Tech', 'Spons Activity Event', '2018/EnTc/September - SponsActivityEvent/1/Screenshot (69).png', 1, '1', -1, '2', NULL),
...
(41, '3', 'EnTc', '3', '0001-01-01', 'Curricular Activity', '3', '3', 'Staff', 'B.Tech', 'Cultural Events', '1970/EnTc/January - CulturalEvents/3/Screenshot (69).png', 1, '3', -1, NULL, NULL),
