...
if(mysqli_connect_error()){
    ...
    $sql="INSERT INTO events (name, department, incharge, date, year, type, eventDescribe, achievements, attendees, eventFor, resourceName, resourceDesignation, category, media, userId, url, approvalStatus) 
        VALUES ('$name', '$department', '$incharge', '$date', '$year', '$type', '$describe', '$achievement', '$attendees', '$for', '$resourceName', '$resourceDesignation', '$category', '$new_name', '$userId', '$new_url', '1')"; 
