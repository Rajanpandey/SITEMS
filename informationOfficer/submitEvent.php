...
if(mysqli_connect_error()){
    ...
    $sql="INSERT INTO events (name, department, incharge, date, type, eventDescribe, achievements, attendees, eventFor, resourceName, resourceDesignation, category, media, userId, url, approvalStatus) 
